...
export const projects: Project[] = [
  {
    ...
    tags: ['Product Design', 'UI Design', 'Premium E-commerce', 'High-fidelity Prototyping'],
  ...
  },
  {
    ...
    tags: ['UI Design', 'B2B SaaS', 'Data Visualization', 'Logistics & Fleet'],
  ...
  },
  {
    ...
    tags: ['UX Design', 'Design Thinking', 'Social Impact', 'Dashboarding'],
  ...
  },
  {
    ...
    tags: ['UX Design', 'Fintech', 'Heuristic Evaluation', 'Accessibility (WCAG)'],
  ...
  },
  {
    ...
    year: '2021',
    category: 'UX Audit',
    tags: ['Product Design', 'Gen-Z UX', 'Gamification', 'Mobile First'],
  ...
  },
  {
    ...
    tags: ['Design Systems', 'Design Ops', 'Lean Methodology', 'Global Governance'],
  ...
  },
  {
    ...
    tags: ['Product Design', 'Creative Direction', 'Visual Identity', 'Community Platform'],
