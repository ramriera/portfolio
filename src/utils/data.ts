...
export const projects: Project[] = [
  {
    ...
    tags: ['Product Design', 'E-commerce', 'UX Design'],
  ...
  class S1,S2,S3,S4,S5,S6 support`,
      ...
      },
      {
        ...
        steps: [
          { title: 'Descubrimiento', description: 'Tasa de clic en "Reservar en tienda" desde la PDP. Benchmark actual: estimado <2% (CTA invisible). **Objetivo: equiparar al CTR de "Añadir a la cesta"** en la misma posición.' },
          { title: 'Completado', description: 'Ratio reservas completadas / reservas iniciadas. El registro obligatorio y los pasos intermedios generan caída acumulativa. **Objetivo: >70% de completado** eliminando registro y reduciendo a 4 pasos.' },
          { title: 'Recogida', description: 'Tasa de recogida efectiva en tienda dentro de 24h. Las reservas sin tracking claro caducan sin ser recogidas. **Objetivo: >85% de recogida** con tracking in-app, push reminders y wallet.' },
        ],
      },
      {
        label: '03. Estrategia UX',
      ...
      // ── 06. Pensamiento de Conversión ──
      {
        ...
        layout: 'stepper',
        content: 'Cada intervención del rediseño responde a un **punto de abandono específico** identificado en la auditoría. No son mejoras genéricas — son acciones quirúrgicas con impacto medible:',
        steps: [
          { title: 'Descubrimiento (PDP)', description: 'CTA visible sin scroll, misma jerarquía que "Añadir a la cesta". Dos variantes para A/B test. **Métrica: tasa de clic en "Reservar en tienda" desde la PDP.**' },
          { title: 'Evaluación (selección de tienda)', description: 'Tienda favorita preseleccionada, stock en tiempo real, horarios de recogida. Sin registro obligatorio. **Métrica: ratio de completado del flujo de selección.**' },
          { title: 'Confianza (resumen y confirmación)', description: '"Pagarás en tienda. Ningún cargo online" en cada punto de contacto clave. Confirmación inmediata con QR + wallet. **Métrica: ratio de reservas confirmadas / iniciadas.**' },
          { title: 'Retención (tracking)', description: 'Estados progresivos, hora estimada, push reminder 2h antes de caducidad. Cross-selling contextual. **Métrica: tasa de recogida efectiva dentro de 24h.**' },
          { title: 'Recuperación (abandonos)', description: 'Push notification si el usuario cierra el flujo: "¿Quieres terminar la reserva en [Tienda]?". Segmentada por punto de abandono. **Métrica: tasa de recuperación de flujos abandonados.**' },
          { title: 'Expansión (cross-selling)', description: 'Looks complementarios del stock de la misma tienda durante el tracking. **Métrica: incremento del ticket medio por visita de recogida.**' },
        ],
  ...
  },
  {
    ...
    tags: ['UX Design', 'Design Systems', 'UX Research'],
  ...
  },
  {
    ...
    year: '2021',
    category: 'Product Design',
    tags: ['Product Design', 'Heuristic Analysis', 'UX Design'],
    description: 'Rediseño de sistema de banca móvil centrado en un principio: el usuario nunca debe preguntarse "¿se ha movido mi dinero?". Máquina de estados, prevención de errores y trust design para operaciones financieras irreversibles.',
    longDescription: 'Imaginbank es la app de banca móvil de CaixaBank para usuarios de **18-30 años**. Este caso documenta un **rediseño de sistema — no visual** — de sus flujos financieros críticos. En banca móvil, un estado ambiguo no es un inconveniente de usabilidad: **es pánico**. Una transferencia sin confirmación no es mala UX: **es riesgo financiero real**.\n\nEl punto de partida: ¿por qué los usuarios cometen errores evitables y pierden confianza al operar con su dinero? **Revolut y N26** habían redefinido el estándar de claridad financiera. Imaginbank necesitaba cerrar esa brecha con **decisiones de producto** — sistema de estados explícito, prevención estructural de errores, y feedback proporcional al riesgo de cada operación.\n\nEs un ejemplo claro de diseño con responsabilidad de negocio: en fintech, cada decisión de interfaz tiene una traducción directa en riesgo financiero, coste de soporte y confianza del usuario en el producto.',
    challenge: 'Tres fallos estructurales con coste financiero directo: (1) **operaciones sin feedback** — el usuario ejecutaba una transferencia y no sabía si estaba en proceso, completada o fallida; (2) **nomenclatura inconsistente** — "Transferir", "Enviar" y "Bizum" para la misma acción, multiplicando la carga cognitiva en flujos donde un error mueve dinero real; (3) **errores sin recuperación** — mensajes genéricos ("Ha ocurrido un error") sin causa, explicación ni ruta de resolución. Estos no son deuda de diseño — **son vectores de pérdida de dinero, confianza y usuarios**.',
    solution: 'Rediseño desde la **arquitectura de comportamiento**, no desde la capa visual. Tres ejes: (1) **máquina de 5 estados explícita** para cada operación — idle, loading, pending, success, failure — sin estados silenciosos; (2) **prevención estructural** — validación en tiempo real, confirmación pre-ejecución obligatoria, bloqueo de doble acción; (3) **jerarquía de datos orientada a la decisión** — saldo disponible primero, pendientes segundo, contexto tercero. Criterio único de evaluación: **¿reduce el riesgo de que el usuario pierda dinero o confianza?**',
    results: [
      'Flujo de transferencia reducido de 8 pasos a 4, manteniendo confirmación de seguridad y resumen pre-ejecución',
      'Máquina de 5 estados explícitos (idle → loading → pending → success/failure) — cero ambigüedad en operaciones con dinero real',
      'De 3 términos para "enviar dinero" a 1 — eliminación de confusión cognitiva en el flujo de mayor riesgo',
      'Validación IBAN en tiempo real + bloqueo de doble ejecución: reducción estimada del 60% en errores de transferencia',
      'Feedback específico por tipo de fallo sustituye "Ha ocurrido un error": reducción estimada del 35% en llamadas a soporte',
    ],
    stack: ['Figma', 'Chrome'],
  ...
  },
  {
    ...
    tags: ['Design Systems', 'Atomic Design', 'UX Research'],
  ...
  },
  {
    ...
    tags: ['Product Design', 'Visual Design', 'Mobile-First Design'],
  ...
  },
  {
    ...
    caseSections: [
      ...
      {
        label: '03. Sistema Tipográfico',
        title: 'Una escala tipográfica pensada para vender confianza, no solo para leerse bien',
        layout: 'full-image',
        content: 'Junto a los tokens de color, documenté una escala tipográfica completa: Display y Heading (H1-H7) en Raleway ExtraBold para titulares con peso editorial, y Subtitle/Body/Table en Noto Sans para el contenido funcional — coberturas, condiciones, precios. Cada token tiene tamaño, line-height, letter-spacing y color de referencia documentados, con una categoría específica llamada **"Insurance"** para textos legales y de condiciones de seguro.\n\nQue exista un token de tipografía dedicado a contenido de seguros no es casualidad: en un producto financiero, la legibilidad de las condiciones no es un detalle estético — es lo que evita reclamaciones por "no lo vi claro". La escala se documenta en dos variantes, web y mobile, para que el mismo criterio se aplique en ambos canales.',
        images: ['/assets/projects/doctori/doctori-typography.png'],
        captions: ['Documentación de la escala tipográfica — Display, Heading, Subtitle, Body, Insurance y Table, con tokens versionados'],
        highlight: 'Un H3 mal definido no es un problema de estética — es un usuario que no distingue el titular de la cobertura del texto legal que la limita.',
      },
      // ── 04. Design Tokens ──
      {
      ...
      // ── 05. Librería de Componentes ──
      {
        ...
        captions: [
          'Librería de componentes — botones, badges, chips y controles de formulario con todos sus estados documentados',
      ...
      // ── 08. Confianza y Contenido Modular ──
      {
        ...
        title: 'Una librería de módulos CMS que el negocio monta sin diseño ni desarrollo',
        layout: 'image-grid',
        content: 'El corazón de la escalabilidad de contenido es una **librería de módulos CMS**: bloques autocontenidos, con su diseño y sus reglas ya definidos, que el equipo de contenido combina como piezas de Lego para montar cualquier landing sin pedir una sola pantalla nueva a diseño o desarrollo. Estos son los módulos que componen el sistema:\n\n**• Cómo Funciona** — resume la propuesta de valor en cuatro pasos (Completas el formulario → Comparamos al instante → Eliges tu mejor opción → Te asesoramos gratis), atacando la desconfianza inicial de un comparador que el usuario no conoce.\n\n**• Opiniones y valoración** — testimonios reales de clientes junto al sello de puntuación global (9.8/10), como prueba social que se reutiliza en todas las verticales.\n\n**• Expertos Visibles** — pone cara y nombre al equipo de asesoramiento, convirtiendo un comparador anónimo en personas con las que se puede hablar.\n\n**• Estudio de mercado** — bloques de datos propios (distribución de precios, edades, coberturas más contratadas por vertical) que funcionan como señal de autoridad, no como relleno.\n\n**• Coberturas frecuentes y FAQ** — resuelven las dudas y objeciones típicas de cada seguro sin saturar el hero.\n\n**• Explicación del modelo de negocio** — transparencia sobre cómo gana dinero el comparador, un módulo de confianza específico del sector.\n\nCada módulo consume los mismos tokens y componentes del sistema, así que combinarlos nunca rompe la coherencia visual. Añadir una variación de landing deja de ser un proyecto y pasa a ser una **composición de bloques ya existentes**.\n\nEsa misma lógica de confianza se extiende a los **modales legales**: cada aseguradora tiene su propio modal de "Información legal del producto" con enlaces a Resumen de coberturas, Condiciones generales y Nota informativa — un requisito regulatorio en mediación de seguros resuelto como un componente reutilizable por aseguradora, no como una excepción por página.',
        images: [
  ...
  },
  {
    ...
    tags: ['Product Design', 'UX Research', 'Service Design'],
    ...
    caseSections: [
      ...
      // ── 02. El Patrón ──
      {
        ...
        images: [
          ...
          '/assets/projects/doctori-tarificador/tarificador-step-modelo.png',
          '/assets/projects/doctori-tarificador/tarificador-step-matricula.png',
          ...
          '/assets/projects/doctori-tarificador/tarificador-step-siniestros.png',
          '/assets/projects/doctori-tarificador/tarificador-step-coberturas.png',
        ],
        captions: [
  ...
  },
  {
    ...
    year: '2022 — Presente',
    category: 'Strategic Product Design',
    tags: ['Product Design', 'UX Research', 'Mobile-First Design'],
    ...
    caseSections: [
      ...
      // ── 04. El Hub Central ──
      {
        ...
        captions: [
          'Home de la app — accesos a las 5 verticales de seguro y listado de profesionales con estado en tiempo real (verde/rojo)',
