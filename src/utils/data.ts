  ...
  },
  {
    ...
    caseSections: [
      ...
      // ── 04. Arquitectura de Tokens y Componentes ──
      {
        ...
        highlight: 'Cualquier cambio en un **Design Token** se propaga instantáneamente a todos los componentes y pantallas del ecosistema digital. Esto transformó actualizaciones que antes requerían semanas de trabajo manual en cambios globales de segundos.',
        images: [
          '/assets/projects/iberia/iberia-header.png',
        ],
      },
      ...
      },
      {
        ...
        mermaidCode: 'graph TD\n  A[Notificación/Home] --> B[Identificación de Vuelo]\n  B --> C[Asignación de Asientos via Tokens]\n  C --> D[Venta de Servicios Extra]\n  D --> E[Check-in Completado]\n  style C fill:#E62232,color:#fff\n  style E fill:#E62232,color:#fff',
        highlight: 'La **Asignación de Asientos** y el **Check-in Completado** son los dos momentos donde la **Librería de Componentes** demuestra su mayor valor: interfaces complejas construidas enteramente con **Átomos y Moléculas** del sistema, sin componentes ad-hoc.',
      },
    ],
  },
  {
