...
export const projects: Project[] = [
  {
    ...
    caseSections: [
      ...
      },
      {
        ...
        captions: [
          'Flujo actual — La opción de reserva enterrada al final de la ficha de producto',
        ],
      },
      {
        label: '01. Auditoría e Investigación',
        ...
        captions: [
          'Selección de tienda con información limitada de disponibilidad',
          'Login obligatorio antes de confirmar la reserva',
        ],
      },
      {
        label: '01. Auditoría e Investigación',
        ...
        captions: [
          'Confirmación mínima que redirige al email',
          'Tracking in-app básico sin progresión visual',
        ],
      },
      ...
      },
      {
        ...
        captions: [
          'Variante con enlace sutil: "¿Lo quieres hoy? Pruébalo en tienda"',
          'Variante con botón secundario de igual prominencia: "Reservar en tienda"',
        ],
      },
      {
        label: '04. Nuevo Flujo de Reserva',
        ...
        captions: [
          'Selección de tienda con disponibilidad real y horarios',
          'Resumen de reserva simplificado — solo email si no está logueado',
        ],
      },
      {
        label: '04. Nuevo Flujo de Reserva',
        ...
        captions: [
          'Confirmación inmediata con código QR y Wallet',
          'Tracking in-app con estados y hora estimada de recogida',
        ],
      },
      {
        label: '04. Nuevo Flujo de Reserva',
        ...
        captions: [
          'Venta cruzada contextual — "Completa tu look en tienda"',
        ],
      },
      // ── 05. Service Design & Post-Visita ──
      {
        ...
        captions: [
          'Concepto de poste de recogida QR en tienda física',
        ],
  ...
  },
  {
    ...
    caseSections: [
      ...
      },
      {
        ...
        captions: [
          'Flota de vehículos eléctricos en España',
          'Evolución de matriculaciones eléctricas en España',
          'Puntos de recarga en España por comunidad autónoma',
          'Estaciones de carga en Europa — Comparativa por país',
          'Flota de coches eléctricos en Europa (2020)',
        ],
      },
      {
        label: '02. Investigación y Análisis',
        ...
        captions: [
          'Apps competidoras del sector de recarga eléctrica',
          'Matriz de benchmarking — Funcionalidades y valoración',
        ],
      },
      {
        ...
        captions: ['User Persona — Oriol Vallmajor, arquitecto y early adopter'],
      },
      {
        label: '03. Definición y Empatía',
        ...
        captions: ['Mapa de empatía — Piensa, siente, oye, ve, dice y hace'],
      },
      {
        label: '03. Definición y Empatía',
        ...
        captions: ['Customer Journey Map — Desde la decisión de compra hasta la recarga en ruta'],
      },
      {
      ...
      },
      {
        ...
        captions: [
          ...
          'Splash screen — Variante de carga',
          'Onboarding — Puntos de carga actualizados',
          'Onboarding — Estado de ocupación en tiempo real',
          'Onboarding — Puntos de cambio de batería',
          'Onboarding — Sistema de reserva',
          'Mapa interactivo principal',
          'Menú lateral con accesos principales',
          'Filtros avanzados por tipo y disponibilidad',
          'Detalle de taller con horarios',
          'Gestión de favoritos',
          'Selección de ubicación para reserva',
          'Flujo de reserva — Fecha y hora',
          'Confirmación de reserva aceptada',
        ],
      },
      {
        label: '06. Conclusión',
  ...
  },
  {
    ...
    tags: ['UX Design', 'Design Thinking', 'Social Impact'],
    ...
    caseSections: [
      {
        ...
        captions: [
          'Brainstorming — Mapa de problemáticas globales',
          'Research Questions — Usuarios, Productos e Instituciones',
        ],
      },
      {
        label: '01. Descubrimiento',
        ...
        captions: [
          'Cuestionario — Resultados sobre hábitos solidarios',
          'Cuestionario — Análisis de respuestas y patrones',
        ],
      },
      {
        label: '02. Definición',
        ...
        captions: [
          'User Persona — Perfil del usuario solidario objetivo',
          'Mapa de empatía — Necesidades, deseos y miedos del usuario',
        ],
      },
      {
        label: '02. Definición',
        ...
        captions: ['Customer Journey Map — Desde el descubrimiento de una causa hasta la acción concreta'],
      },
      {
        ...
        captions: ['Benchmarking — Análisis comparativo de plataformas solidarias'],
      },
      {
        label: '04. Desarrollo',
        ...
        captions: [
          'Foundations — Color, tipografía, iconografía, grid y espaciado',
          'Librería de componentes — Botones, cards, inputs y navegación',
        ],
      },
      {
        label: '04. Desarrollo',
        ...
        captions: ['Wireframes — Evolución de baja a alta fidelidad'],
      },
      {
  ...
  },
  {
    ...
    longDescription: 'Imaginbank no es solo un banco - es el <u>ecosistema digital de CaixaBank para jóvenes</u>. Lanzado en 2016 como banco 100% móvil, su misión era captar al público nativo digital con servicios financieros ágiles y sin sucursales. Pero el mercado evolucionó más rápido que el producto: <u>Revolut, N26 y Bnext</u> redefinieron las expectativas con onboardings de 5 minutos, interfaces que se sienten como apps de consumo y experiencias que conectan emocionalmente con la Gen Z.\n\nEl reto fue claro: <u>evolucionar la experiencia mobile para conectar con la Generación Z</u> mediante un lenguaje visual dinámico y funcional. No bastaba con optimizar - había que transformar la percepción de "app bancaria tradicional" en una <u>herramienta financiera moderna</u> que los jóvenes quisieran usar a diario.',
    challenge: '¿Cómo hacer que un banco <u>no parezca un banco</u>? Los jóvenes de 18-30 años son usuarios intensivos de apps de consumo (Instagram, TikTok, Spotify) y esperan esa misma calidad en su app bancaria. La interfaz de Imaginbank hablaba un <u>lenguaje bancario tradicional</u>, los flujos requerían demasiados pasos para acciones simples, y la experiencia se sentía como "la app del banco de mis padres". La brecha entre las expectativas definidas por los neobancos y la realidad de Imaginbank generaba <u>abandono silencioso</u>: usuarios que descargaban la app pero migraban a alternativas en semanas.',
    solution: 'Se abordó el proyecto con un enfoque de <u>Product Design Mobile First</u>, combinando auditoría heurística con User Testing en segmentos jóvenes. La estrategia se centró en tres ejes: <u>gamificación</u> de interacciones financieras cotidianas (retos de ahorro, logros, progreso visual), <u>agilidad</u> en los flujos core (reducir taps, eliminar jerga, feedback instantáneo), y <u>componentes modulares</u> con micro-interacciones que convirtieran cada acción financiera en una experiencia gratificante.',
    results: [
      'Incremento estimado del <u>+28% en retención diaria</u> gracias a mecánicas de gamificación',
      'Reducción del <u>-45% en tiempo de onboarding</u> simplificando el registro a 3 pasos',
      'Mejora del <u>+22 puntos en CSAT</u> (Customer Satisfaction Score)',
      'Identificados <u>12+ fallos de usabilidad</u> categorizados por severidad con metodología Nielsen',
      'ROI estimado: <u>-35% llamadas a soporte</u>, <u>+20% conversión onboarding</u>',
    ],
    stack: ['Figma', 'Chrome'],
    ...
    caseSections: [
      // ── 01. El Reto ──
      {
        ...
        layout: 'image-grid',
        content: 'Imaginbank nació en 2016 como la apuesta de CaixaBank por captar al <u>público joven y nativo digital</u>. Banco <u>100% móvil</u>, sin sucursales, con servicios financieros diseñados para operar exclusivamente desde el smartphone. La propuesta era clara: competir con los <u>neobancos</u> que estaban redefiniendo la banca.\n\nPero el mercado evolucionó más rápido que el producto. <u>Revolut, N26 y Bnext</u> elevaron el estándar con <u>onboardings de 5 minutos</u>, interfaces ultra-limpias y experiencias que se sienten más como <u>apps de consumo</u> que como banca tradicional. La <u>Gen Z</u> espera ese nivel de calidad - y Imaginbank necesitaba entender por qué <u>no conectaba con ellos</u> a pesar de ser un producto digital-first.',
      ...
      },
      {
        ...
        layout: 'center',
        content: 'El target de Imaginbank es claro: <u>jóvenes de 18-30 años</u>, nativos digitales, <u>usuarios intensivos de apps de consumo</u> que esperan la misma calidad de experiencia en su app bancaria.\n\nSu frustración nace de una interfaz que <u>no habla su lenguaje</u>: <u>nomenclatura bancaria tradicional</u> en lugar de términos directos, flujos que requieren <u>demasiados pasos</u> para acciones simples, y una experiencia que se siente como "la app del banco de mis padres" en lugar de una <u>herramienta financiera moderna</u>. La brecha entre expectativas (definidas por <u>Revolut, N26</u>) y realidad (Imaginbank) es lo que genera <u>abandono</u>.\n\nEl reto no era solo estético. Necesitábamos repensar la experiencia desde la <u>gamificación</u> (hacer que gestionar dinero sea gratificante) y la <u>agilidad</u> (cada acción en el menor número de taps posible).',
        highlight: 'La Gen Z no abandona la app porque no la necesite - la abandona porque <u>hay alternativas que les hacen sentir que controlan su dinero</u>, no que un banco lo controla por ellos.',
      },
      // ── 02. Metodología ──
      {
        ...
        layout: 'center',
        content: 'El enfoque metodológico combinó dos pilares complementarios:\n\n<u>Mobile First como principio de diseño</u> - Cada decisión se tomó pensando primero en el contexto móvil: pantallas pequeñas, atención fragmentada, uso con una mano, notificaciones como canal principal. No se adaptó una experiencia desktop - se diseñó desde el pulgar.\n\n<u>User Testing con segmentos jóvenes</u> - Se realizaron sesiones de evaluación con usuarios de 18-25 años, observando cómo interactuaban con la app actual y con prototipos de las propuestas. Los hallazgos confirmaron que el problema no era funcional sino <u>emocional</u>: la app funcionaba, pero no les hacía sentir que era *su* herramienta financiera.',
        bullets: [
          '<u>Análisis Heurístico</u> - Evaluación experta con las <u>10 Heurísticas de Jakob Nielsen</u> como marco de diagnóstico, examinando cada flujo clave de la aplicación',
          '<u>User Testing cualitativo</u> - Sesiones con usuarios de 18-25 años para validar hipótesis y detectar fricciones emocionales que el análisis experto no captura',
          '<u>Benchmarking competitivo</u> - Análisis profundo de Revolut, N26 y Bnext para identificar los patrones que la Gen Z ya considera estándar',
          '<u>Severity Rating</u> - Clasificación de hallazgos por impacto y frecuencia para priorizar las intervenciones con mayor ROI',
        ],
      },
      // ── 03. Diagnóstico ──
      {
        ...
        layout: 'image-grid',
        content: 'El sistema debe mantener al usuario informado en todo momento sobre lo que está ocurriendo, mediante <u>feedback apropiado</u> y en un tiempo razonable.\n\nEn esta pantalla de la app, la <u>Heurística #1 falla</u> porque no existe ningún indicador visual que confirme al usuario que su transferencia se está procesando. La ausencia de un <u>spinner, barra de progreso o mensaje de estado</u> deja al usuario en la incertidumbre - un problema crítico cuando se trata de <u>dinero real</u>.\n\n<u>Hallazgo:</u> La app no proporciona feedback visual suficiente al realizar acciones críticas como transferencias o pagos. El usuario no sabe si una operación está en proceso, se ha completado o ha fallado.\n\n<u>Recomendación:</u> Implementar sistema de feedback con estados de progreso, confirmaciones visuales claras y notificaciones en tiempo real para todas las operaciones financieras.',
        highlight: 'La falta de feedback en <u>acciones financieras críticas</u> compromete la <u>confianza del usuario</u> en los momentos donde más la necesita.',
      ...
      },
      {
        ...
        layout: 'image-grid',
        content: 'Los usuarios no deberían tener que preguntarse si diferentes palabras, situaciones o acciones significan lo mismo.\n\nEn estas pantallas se evidencia cómo la <u>Heurística #4 se incumple</u> de forma sistemática: la misma acción de enviar dinero aparece como "Transferir", "Enviar" y "Bizum" en diferentes secciones. La <u>iconografía</u> no sigue un <u>lenguaje visual coherente</u> y algunos <u>patrones de interacción</u> varían entre pantallas similares.\n\n<u>Hallazgo:</u> Inconsistencias en la nomenclatura de funciones: las mismas acciones reciben nombres diferentes según la sección. La iconografía no sigue un lenguaje visual coherente.\n\n<u>Recomendación:</u> Crear un sistema de design tokens unificado con nomenclatura consistente. Auditar todos los labels y unificar terminología en un glosario UX.',
        highlight: 'La <u>nomenclatura inconsistente</u> entre secciones genera <u>confusión cognitiva</u> - el usuario tiene que "reaprender" la interfaz en cada pantalla.',
      ...
      },
      {
        ...
        layout: 'image-grid',
        content: 'Los usuarios necesitan una <u>"salida de emergencia"</u> clara para abandonar estados no deseados sin tener que pasar por un proceso extenso.\n\nEn estas capturas se observa cómo la <u>Heurística #3 se vulnera</u> de forma crítica: la <u>falta de flexibilidad</u> impide al usuario <u>deshacer acciones</u>, volver atrás de forma intuitiva o acceder a <u>opciones secundarias</u> sin recorrer múltiples pantallas.\n\n<u>Hallazgo:</u> La navegación es rígida: no hay opción de deshacer acciones, volver atrás es confuso y las opciones secundarias están enterradas en submenús.\n\n<u>Recomendación:</u> Implementar acción "Undo" en el flujo de transacciones. Añadir accesos directos contextuales y simplificar la navegación de retorno.',
      ...
      },
      {
        ...
        layout: 'image-grid',
        content: 'Un diseño cuidadoso que <u>prevenga errores</u> es mejor que buenos mensajes de error. Y cuando los errores ocurren, el sistema debe expresarlos en <u>lenguaje claro</u> y ofrecer una <u>solución constructiva</u>.\n\nEn estas pantallas se identifica cómo las <u>Heurísticas #5 y #9 fallan simultáneamente</u>: los <u>mensajes de error son genéricos</u> ("Ha ocurrido un error") sin orientar al usuario hacia la solución.\n\n<u>Hallazgo:</u> Los mensajes de error son genéricos y no orientan al usuario hacia la solución. No existen confirmaciones claras ni mecanismos de "undo" en operaciones financieras.\n\n<u>Recomendación:</u> Rediseñar mensajes de error con lenguaje claro y accionable. Añadir confirmación previa en operaciones irreversibles y opción de cancelar/revertir.',
        highlight: 'Los <u>mensajes de error genéricos</u> en operaciones financieras no solo frustran - <u>erosionan activamente la confianza</u> en la plataforma.',
      ...
      },
      {
        ...
        layout: 'image-grid',
        content: 'Cada unidad extra de información compite con las unidades relevantes y <u>disminuye su visibilidad relativa</u>.\n\nEn estas pantallas vemos cómo la <u>Heurística #8 presenta debilidades</u>: aunque la estética general era limpia, se detectaron áreas donde la <u>jerarquía visual era confusa</u> y <u>elementos decorativos competían</u> con la información funcional.\n\n<u>Hallazgo:</u> La jerarquía visual es confusa en algunas pantallas. Elementos decorativos compiten con información funcional. Bizum y transferencias rápidas no tienen la prominencia que su frecuencia de uso justifica.\n\n<u>Recomendación:</u> Aplicar progressive disclosure. Priorizar visualmente las 3-4 acciones más frecuentes. Reducir ruido visual en pantallas de información financiera.',
      ...
      // ── 04. Solución ──
      {
        ...
        layout: 'center',
        content: 'La solución técnica se centró en crear un <u>sistema de componentes modulares</u> diseñados para Mobile First que pudieran combinarse y reutilizarse en toda la app, garantizando consistencia visual y reduciendo el tiempo de desarrollo.\n\nCada componente incorpora <u>micro-interacciones</u> que transforman las acciones financieras cotidianas en momentos gratificantes: animaciones de confirmación cuando se completa una transferencia, progreso visual en los retos de ahorro, feedback háptico en acciones críticas, y transiciones fluidas que transmiten <u>velocidad y control</u>.',
        bullets: [
          '<u>Crítico</u> - Rediseñar el <u>sistema de feedback</u> de acciones financieras: <u>confirmaciones visuales claras</u>, estados de progreso y <u>mensajes de error constructivos</u> que guíen al usuario hacia la solución',
          '<u>Alto</u> - Unificar la <u>nomenclatura</u> en toda la app: lenguaje <u>consistente, directo</u> y alineado con el vocabulario del usuario joven, eliminando <u>jerga bancaria innecesaria</u>',
          '<u>Alto</u> - Flexibilizar la <u>navegación</u>: accesos directos a acciones frecuentes (<u>Bizum, transferencias</u>), <u>"deshacer" accesible</u> y opciones secundarias visibles sin explorar submenús',
          '<u>Medio</u> - Optimizar la <u>jerarquía visual</u>: priorizar las <u>3-4 acciones más frecuentes</u> en la pantalla principal, reducir el <u>ruido visual</u> y aplicar <u>progressive disclosure</u>',
        ],
        bulletEvidence: [
      ...
      },
      {
        ...
        layout: 'image-grid',
        content: 'Las mejoras propuestas abarcan tanto la <u>arquitectura de información</u> como el <u>diseño visual</u>. A nivel arquitectónico: <u>simplificación de la navegación</u> principal a <u>4-5 secciones claras</u>, <u>accesos directos contextuales</u> y reducción de la profundidad de los flujos más frecuentes.\n\nA nivel visual: sistema de <u>feedback con micro-interacciones</u>, <u>jerarquía tipográfica revisada</u> para priorizar la información financiera clave, y un <u>lenguaje visual</u> más cercano al estándar de los neobancos. Cada pantalla respira el principio de <u>"menos es más"</u> - eliminar ruido para que el usuario se enfoque en lo que importa.',
      ...
      },
      {
        ...
        layout: 'center',
        content: 'El journey del usuario con Imaginbank revelaba <u>tres momentos críticos</u> que la solución aborda directamente:',
        bullets: [
          '<u>Onboarding</u> - De un registro largo con terminología bancaria a un flujo de <u>3 pasos</u> con lenguaje directo, verificación biométrica y personalización inmediata. El usuario tiene su cuenta operativa en menos de 3 minutos',
          '<u>Primera transferencia</u> - De un flujo sin feedback a una experiencia con <u>confirmación visual instantánea</u>, animación de éxito, notificación push al destinatario y opción de repetir con un tap',
          '<u>Gestión de tarjetas</u> - De opciones enterradas en submenús a <u>accesos directos contextuales</u>: bloquear/desbloquear con swipe, cambiar PIN con biometría, ver movimientos en tiempo real',
        ],
        highlight: 'Cada punto de fricción resuelto se traduce en <u>usuarios que completan flujos</u> en lugar de abandonarlos. La frustración acumulada en micro-interacciones es lo que diferencia una app que se usa a diario de una que se desinstala en semanas.',
      },
      // ── 06. Métricas de Impacto ──
      {
        ...
        layout: 'center',
        content: 'Cada decisión de diseño se vinculó a una <u>métrica de negocio medible</u>. Los problemas de usabilidad identificados generaban fricción que se traducía en costes reales: llamadas a soporte, abandono de onboarding, y usuarios que migraban a la competencia. Las mejoras propuestas generan un <u>retorno de inversión tangible</u>:',
        bullets: [
          '<u>+28% retención diaria</u> - Las mecánicas de gamificación (retos de ahorro, logros, progreso visual) convierten la gestión financiera en un hábito gratificante, no una obligación',
          '<u>-45% tiempo de onboarding</u> - Simplificar el registro de 8 pasos a 3, eliminar jerga bancaria y añadir verificación biométrica reduce el abandono en los primeros minutos críticos',
          '<u>+22 puntos CSAT</u> - Una experiencia consistente, con feedback claro, micro-interacciones y control del usuario, transforma la percepción de la marca de "banco tradicional" a "herramienta financiera moderna"',
          '<u>-35% llamadas a soporte</u> - Mensajes de error claros y feedback visual adecuado reducen drásticamente las consultas de "¿qué ha pasado con mi transferencia?"',
          '<u>+20% conversión onboarding</u> - Eliminar registro obligatorio y jerga bancaria convierte visitantes en usuarios activos desde el primer día',
        ],
        highlight: 'La inversión en UX se paga sola: cada <u>punto de fricción eliminado</u> reduce costes operativos y aumenta la retención. Cuando los usuarios dejan de llamar a soporte para preguntar "¿dónde está mi dinero?", el <u>ROI del diseño</u> se vuelve indiscutible.',
      },
    ],
  },
  {
    ...
    tags: ['Design Systems', 'Design Ops', 'Enterprise'],
